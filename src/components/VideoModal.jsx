    ...
    return (
        <div className="videoModal" onClick={onClose}>
            <div className="videoModal__content" onClick={(e) => e.stopPropagation()}>
                <button type="button" className="videoModal__close z-50" onClick={onClose}>
                    <FaTimes />
                </button>
                ...
                {view === 'player' ? (
                    <div className="flex flex-col h-full relative bg-black">
                        ...
                        {!movie?.video_url && (
                            <div className="p-3 flex justify-center bg-black/90 border-t border-white/10 z-40">
                                <button
                                    type="button"
                                    onClick={() => setView('detail')}
                                    className="text-cyan-400 hover:text-cyan-300 transition-colors text-xs font-bold tracking-widest uppercase flex items-center gap-2"
                                >
                                    ← Back to Movie Info & Reviews
                                </button>
                            </div>
                        )}
                    </div>
